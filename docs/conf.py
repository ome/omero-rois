...
autodoc_mock_imports = ['numpy', 'omero']
...
man_pages = [
    (master_doc, 'omerorois', u'OMERO ROIs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OMEROROIs', u'OMERO ROIs Documentation',
     author, 'OMEROROIs', 'One line description of project.',
     'Miscellaneous'),
]
